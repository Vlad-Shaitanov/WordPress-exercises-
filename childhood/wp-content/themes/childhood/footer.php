 <div class="question">
            ...
            <div class="reply__body">
                ...
                <form action="#">
                    <div class="reply__wrapper">
                        <div>
                            <label for="your_name">Ваше имя <span>*</span></label>
                            <input name="your_name" id="your_name" type="text" required>
                        </div>
                    </div>
                    <div class="reply__wrapper">
                        <div>
	...
	<!--Ваш ключ Google API-->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDVD3Je6TPxAi_sdOWK2AycQUc4FG1p1zA"></script> 
